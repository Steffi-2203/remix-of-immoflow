...
export const mockTenants: DemoTenant[] = [
  {
    ...
    unit_id: 'demo-unit-1',
    first_name: 'Muster',
    last_name: 'Gastro GmbH',
    email: 'demo-gastro@beispiel.at',
    phone: '+43 1 000 0001',
    ...
    bic: 'DEMO0000',
    mandat_reference: 'SEPA-DEMO-001',
    status: 'aktiv',
  ...
  },
  {
    ...
    email: 'erika.mustermann@beispiel.at',
    phone: '+43 664 000 0002',
    ...
    bic: 'DEMO0000',
    mandat_reference: 'SEPA-DEMO-002',
    status: 'aktiv',
  ...
  },
  {
    ...
    first_name: 'Familie',
    last_name: 'Mustermann',
    email: 'familie.mustermann@beispiel.at',
    phone: '+43 699 000 0003',
  ...
  },
  {
    ...
    vorschuss_gueltig_ab: null,
    sepa_mandat: true,
    iban: 'AT00 0000 0000 0000 0004',
    bic: 'DEMO0000',
    mandat_reference: 'SEPA-DEMO-004',
    status: 'aktiv',
...
export const mockTransactions: DemoTransaction[] = [
  {
    ...
    counterparty_name: 'Muster Gastro GmbH',
    counterparty_iban: 'AT00 0000 0000 0000 0001',
  ...
  },
  {
    ...
    counterparty_name: 'Erika Mustermann',
    counterparty_iban: 'AT00 0000 0000 0000 0002',
  ...
  },
  {
    ...
    counterparty_name: 'Familie Mustermann',
    counterparty_iban: 'AT00 0000 0000 0000 0003',
...
export const mockMessages: DemoMessage[] = [
  {
    ...
    recipient_email: 'familie.mustermann@beispiel.at',
  ...
  },
  {
    ...
    maintenance_task_id: null,
    recipient_type: 'tenant',
    recipient_name: 'Muster Gastro GmbH',
    recipient_email: 'demo-gastro@beispiel.at',
    recipient_phone: null,
  ...
  },
  {
    ...
    recipient_email: 'erika.mustermann@beispiel.at',
    recipient_phone: null,
    subject: 'Mietanpassung ab 01.04.2025',
    message_body: 'Sehr geehrte Frau Mustermann, wir informieren Sie über die Anpassung Ihres Mietzinses gemäß Richtwertgesetz ab 01.04.2025.',
    message_type: 'email',
    status: 'draft',
    sent_at: null,
    created_by: null,
